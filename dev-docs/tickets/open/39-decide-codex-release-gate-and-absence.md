...
Graduated from the map's fog once [Research what a third party can ship to Codex](../done/34-research-codex-extension-surface.md) established what Codex actually loads.
