...
Big decisions — breaking, expensive to undo, or with multiple serious options — get the full MADR v4.0.0 template from the ws plugin's `adr` skill (`/ws-docs adr`) instead of this lightweight format.
