...
- **Handoff protocol:** decisions land in `CONTEXT.md` and `docs/adr/` and are referenced by path; the idea thread itself is state — don't compact or clear it mid-flow (DONE|{CONTEXT.md, docs/adr/...}).
