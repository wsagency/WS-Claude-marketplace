...
- Make the release gate reject dirty or unexpected commits, mismatched tarball digests, failed installation commands, and stale Claude Code or omp plugin identities before publication (WCM-1)
